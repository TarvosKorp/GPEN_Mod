...
import __init_paths
from face_detect.retinaface_detection2 import RetinaFaceDetection
...
if __name__=='__main__':
    ...
    for n, file in enumerate(files[:]):
        ...
        cv2.imwrite(os.path.join(args.outdir, '.'.join(filename.split('.')[:-1])+'_2.jpg'), img)
        ...
        #for m, (ef, of) in enumerate(zip(enhanced_faces, orig_faces)):
            ...
            #cv2.imwrite(os.path.join(args.outdir, '.'.join(filename.split('.')[:-1])+'_face%02d'%m+'.jpg'), ef)

...
def brush_stroke_mask(img, color=(255,255,255)):
    ...
    #mask = '/content/drive/MyDrive/GPEN/examples/imgs_in/Inpaint_Heads3_Mask.png'
    mask = generate_mask(height, width, img)
    cv2.imwrite('/content/drive/MyDrive/GPEN/examples/outs_in/image.png', mask)
    return mask
...
if __name__=='__main__':
    ...
    indir = 'examples/imgs_in'
    outdir = 'examples/outs_in'
